...
public class DownloadUtils {
    ...
    public ReturnResponse<String> downLoad(String urlAddress, String type, String fileName){
        ...
        String msg =this.messageSource.getMessage("downLoadsucess",null,locale);
        ReturnResponse<String> response = new ReturnResponse<String>(0, msg, "");
        URL url = null;
        try {
        ...
        try {
            ...
            if (e instanceof FileNotFoundException) {
                String msgerr =this.messageSource.getMessage("downLoaderror",null,locale);
                response.setMsg(msgerr);
            }else {
     ...
     * 对最有一个路径进行转码
     * @param urlAddress
     *          http://192.168.27.68:8012/demo/中文.zip
     * @return
     */
