...
import com.venustech.web.model.FileType;
...
public class FileUtils {
     ...
     * 从url中剥离出文件名
     * @param url
     *      格式如：http://*.com.cn/20180113217203_月度绩效表模板(新).xls?Key=3247152091875823745&Expires=
     * @return
     */
    ...
    public void doActionConvertedFile(String outFilePath) {
        ...
        try (InputStream inputStream = new FileInputStream(outFilePath);
            ...
            // 添加sheet控制头
            sb.append("<script src=\"js/jquery-3.3.1.min.js\" type=\"text/javascript\"></script>");
