...
<div class="panel-group" id="accordion">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapseTwo" class="panel-collapse collapse">
            <div class="panel-body">
                <p style="color: red;">测试,一种文件只允许上传一个</p>
    ...
    <div class="panel">
        ...
        <div id="collapseThree" class="panel-collapse collapse in">
            <div class="panel-body">
                <div>
                  <!--   2018年04月03日 ：<br>
                    1.更换jodconverter-core版本，使用jodconverter 4.2.0<br><br>
                    2.更新依赖包 commons-io -> 2.6 、 fr.opensagres.xdocreport -> 1.0.6 poi -> 3.17  redisson -> 3.5.7<br><br> -->
